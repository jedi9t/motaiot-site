...
{Your App Name} provides a platform offering information, resources, and an AI-powered conversational service ("AI Chat"). The AI Chat service is for informational and entertainment purposes only. The information provided by the AI Chat service is not guaranteed to be accurate, complete, or current.
...
* **Site Content:** All content, graphics, and code on the Site (excluding user submissions) are the property of {Your App Name} or its licensors.
